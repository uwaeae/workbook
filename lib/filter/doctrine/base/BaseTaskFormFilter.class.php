...
abstract class BaseTaskFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'correction_time' => new sfWidgetFormFilterInput(),
      'correction_info' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'overtime'        => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
