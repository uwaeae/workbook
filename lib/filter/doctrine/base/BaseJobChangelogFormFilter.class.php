...
/**
 * JobChangelog filter form base class.
 *
 * @package    workbook
 * @subpackage filter
 ...
 */
abstract class BaseJobChangelogFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('job_changelog_filters[%s]');
