...
abstract class BaseTaskForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'correction_time' => new sfWidgetFormInputText(),
      'correction_info' => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'correction_time' => new sfValidatorInteger(array('required' => false)),
      'correction_info' => new sfValidatorString(array('required' => false)),
