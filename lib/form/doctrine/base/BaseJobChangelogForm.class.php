...
/**
 * JobChangelog form base class.
 *
 * @method JobChangelog getObject() Returns the current form's model object
 *
 * @package    workbook
 * @subpackage form
 ...
 */
abstract class BaseJobChangelogForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('job_changelog[%s]');
