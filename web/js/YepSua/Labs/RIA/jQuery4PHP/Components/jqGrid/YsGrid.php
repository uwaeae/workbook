...
EOH;
  ...
  public function editSelectedRow($validateSelection = false, $message = null) {
    ...
    if ($validateSelection) {
      if ($message === null) {
        $jquery = $this->invoke('editRow', $id)->conditionNOT($this->invoke('getGridParam', 'selrow'));
      } else {
        $jquery = $this->invoke('editRow', $id)->conditionNOT($this->invoke('getGridParam', 'selrow'), sprintf('alert("%s")', $message));
      }
    } else {
