...
require_once(dirname(__FILE__).'/../lib/BaseItemGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseItemGeneratorHelper.class.php');
 ...
 */
abstract class autoItemActions extends sfActions
{
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'Item'));
    try
    {
      // validate ids
  ...
  {
    return Doctrine_Core::getTable('Item')->hasColumn($column);
  }
}
